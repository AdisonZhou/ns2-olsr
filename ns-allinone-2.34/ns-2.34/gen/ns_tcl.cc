...
\"\n\
checkout_executable TCLSH \"/home/zhou/src/ns-allinone-2.34/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/zhou/src/ns-allinone-2.34/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
MPOLSR  # routing protocol for ad-hoc networks\n\
AOLSR  # routing protocol for ad-hoc networks\n\
...
\n\
Agent/MPOLSR set sport_   0\n\
Agent/MPOLSR set dport_   0\n\
\n\
Agent/AOLSR set sport_   0\n\
Agent/AOLSR set dport_   0\n\
\n\
Agent/BOLSR set sport_   0\n\
Agent/BOLSR set dport_   0\n\
\n\
\n\
...
\n\
Agent/AOLSR set debug_       false\n\
Agent/AOLSR set use_mac_     false\n\
Agent/AOLSR set willingness_ 3\n\
Agent/AOLSR set hello_ival_  2\n\
Agent/AOLSR set tc_ival_     5\n\
Agent/AOLSR set mid_ival_    5\n\
\n\
\n\
...
\n\
Agent/MPOLSR set debug_       false\n\
Agent/MPOLSR set use_mac_     false\n\
Agent/MPOLSR set willingness_ 3\n\
Agent/MPOLSR set hello_ival_  2\n\
Agent/MPOLSR set tc_ival_     5\n\
Agent/MPOLSR set mid_ival_    5\n\
\n\
...
MPOLSR {\n\
set ragent [$self create-mpolsr-agent $node]\n\
}\n\
AOLSR {\n\
set ragent [$self create-aolsr-agent $node]\n\
}\n\
BOLSR {\n\
...
\n\
Simulator instproc create-mpolsr-agent { node } {\n\
set ragent [new Agent/MPOLSR [$node node-addr]]\n\
$self at 0.0 \"$ragent start\"\n\
$node set ragent_ $ragent\n\
return $ragent\n\
}\n\
\n\
Simulator instproc create-aolsr-agent { node } {\n\
set ragent [new Agent/AOLSR [$node node-addr]]\n\
$self at 0.0 \"$ragent start\"\n\
$node set ragent_ $ragent\n\
return $ragent\n\
}\n\
