...
set opt(nn)             32                       ;# number of mobilenodes
set opt(adhocRouting)   OLSR                     ;# routing protocol
set opt(cp)             ""               ;# connection pattern file
set opt(sc)             "scen_test1"   ;# node movement file. 
set opt(tr)		olsr.tr          ;# trace file
set opt(nam)            olsr.nam	 ;# nam trace file
set opt(x)              800                      ;# x coordinate of topology
set opt(y)              800                      ;# y coordinate of topology
set opt(seed)           1.0                      ;# seed for random number gen.
set opt(stop)           120.0                     ;# time to stop simulation
...
#$ns_ at 5.3 "$node_(6) start"
#$ns_ at 4.6 "$node_(15) start"	
$ns_ at 0.1 "$node_(6) start"
#$ns_ at 0.2 "$node_(15) start"	
#
...
$ns_ attach-agent $node_(30) $udp_(1)
set null_(1) [new Agent/Null]
$ns_ attach-agent $node_(31) $null_(1)
set cbr_(1) [new Application/Traffic/CBR]
$cbr_(1) set packetSize_ 512  ;#数据分组的大小为250字节
$cbr_(1) set rate_ $opt(rate)kb  ;#在On状态时数据的发送速率50kb/s
$cbr_(1) attach-agent $udp_(1)
$ns_ connect $udp_(1) $null_(1)
$ns_ at 43.66623783515126 "$cbr_(1) start"
$ns_ at 105.66623783515126 "$cbr_(1) stop"
#
...
#$ns_ at 34.66623783515126 "$cbr_(2) start"
$ns_ at 93.66623783515126 "$cbr_(2) stop"
